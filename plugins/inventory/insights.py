...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        if get_patching_info:
            stale_patches = self.get_patches(stale=True, get_system_advisories=get_system_advisories,
                                             get_system_packages=get_system_packages, filter_tags=filter_tags)
            patches = self.get_patches(stale=False, get_system_advisories=get_system_advisories,
                                       get_system_packages=get_system_packages, filter_tags=filter_tags)
